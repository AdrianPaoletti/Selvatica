    ...
    <section className="contact u-padding-medium" id="contact">
      ...
      <article className="contact-content">
        <div className="contact-block contact-block--info u-padding-top-medium">
          <div>
            <p className="contact-text text-main u-bold u-margin-left-right-medium">
              Dirección
            </p>
            <p className="contact-text text-main u-margin-left-right-medium">
              Paseo marítimo 201, 08860 – Castelldefels (Barcelona)
            </p>
            <p className="contact-text text-main u-bold u-padding-top-medium u-margin-left-right-medium">
              Contacto
            </p>
            <p className="contact-text text-main u-margin-left-right-medium">
              +34 657 099 946
        ...
        <div className="contact-block contact-block--map u-margin-left-right-medium  u-padding-top-medium">
